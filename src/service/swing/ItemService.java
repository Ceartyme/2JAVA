...
public class ItemService {
    ...
    public static void updateItem(String name, double price, Item item) throws Exception{
    ...
    public static ArrayList<Store> getStoresFromItem(Item item) throws Exception{
    ...
    public static void createItem(String name, double price) throws Exception{
        if(name.isEmpty()){
